...
def main():
    ...
    group.add_argument("--resource-data", help="Path to resource data JSON file")
    group.add_argument("--resource-data-json", help="Resource data as inline JSON string")
    args = parser.parse_args()

    # Load resource data
    if args.resource_data_json:
        resource_data = json.loads(args.resource_data_json)
    else:
